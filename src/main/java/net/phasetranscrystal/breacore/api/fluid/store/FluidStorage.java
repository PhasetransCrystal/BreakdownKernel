...
public interface FluidStorage {
     ...
     */
    void enqueueRegistration(@NotNull FluidStorageKey key, @NotNull FluidRegisterBuilder builder);
     ...
     */
    @Nullable
    FluidRegisterBuilder getQueuedBuilder(@NotNull FluidStorageKey key);
