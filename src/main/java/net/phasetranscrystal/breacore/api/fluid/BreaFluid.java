...
import net.phasetranscrystal.breacore.api.fluid.attribute.FluidAttribute;
import net.phasetranscrystal.breacore.api.fluid.attribute.IAttributedFluid;
...
public abstract class BreaFluid extends BaseFlowingFluid implements IAttributedFluid {
    ...
    public BreaFluid(@NotNull FluidState state, int burnTime, Properties properties) {
        super(properties);
        this.state = state;
    ...
    public static class Source extends BreaFluid {

        public Source(@NotNull FluidState state, int burnTime, Properties properties) {
    ...
    public static class Flowing extends BreaFluid {

        public Flowing(@NotNull FluidState state, int burnTime, Properties properties) {
            super(state, burnTime, properties);
