...
import net.phasetranscrystal.brealib.util.ColorUtil;
...
import net.phasetranscrystal.breacore.api.item.MaterialBucketItem;
import net.phasetranscrystal.breacore.api.material.Material;
import net.phasetranscrystal.breacore.api.material.info.MaterialFlags;
import net.phasetranscrystal.breacore.api.material.property.BlastProperty;
...
import static net.phasetranscrystal.breacore.api.fluid.FluidConstants.*;
...
public class FluidRegisterBuilder {
    ...
    public @NotNull FluidRegisterBuilder color(int color) {
        this.color = ColorUtil.convertRGBtoARGB(color);
    ...
    public void determineTextures(@NotNull Material material, @Nullable FluidStorageKey key) {
        ...
        if (hasCustomFlowing) {
            flowing = Identifier.fromNamespaceAndPath(material.getModid(), "block/fluids/fluid." + name + "_flow");
        } else {
    ...
    private void determineColor(@NotNull Material material) {
        ...
        if (isColorEnabled && !material.isNull()) {
            color = ColorUtil.convertRGBtoARGB(material.getMaterialRGB());
        }
    }
