...
public final class AttributeRegistry {
    ...
    public static final Map<Element, RegistryEntry<Attribute, Attribute>> SPELL_DAMAGE_AMPLIFICATION_BY_ELEMENT = new EnumMap<>(Element.class);
    public static final Map<Element, RegistryEntry<Attribute, Attribute>> SPELL_DAMAGE_RESISTANCE_BY_ELEMENT = new EnumMap<>(Element.class);
