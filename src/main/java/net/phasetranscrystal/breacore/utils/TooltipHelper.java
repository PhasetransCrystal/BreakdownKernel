...
import net.phasetranscrystal.brealib.util.GradientUtil;
...
public class TooltipHelper {
    ...
    public static GTFormattingCode createNewCode(int rate, ChatFormatting... codes) {
        if (rate <= 0) {
            ...
            BreakdownCore.LOGGER.error("Could not create GT Formatting Code with codes {}, must have length greater than one!", Arrays.toString(codes));
            return null;
        }
    }
