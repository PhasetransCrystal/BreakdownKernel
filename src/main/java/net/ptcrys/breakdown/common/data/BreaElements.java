...
import net.ptcrys.breakdown.api.material.Element;

import net.minecraft.core.Holder;

import java.util.Optional;

import static net.ptcrys.breakdown.api.registry.BreaRegistries.ELEMENTS;
...
public class BreaElements {
    ...
    public static Element createAndRegister(long protons, long neutrons, long halfLifeSeconds, String decayTo,
        ...
        ELEMENTS.register(BreaLib.id(name), element);
        return element;
    }
    ...
    public static Optional<Element> get(String name) {
        return ELEMENTS.get(BreaLib.id(name)).map(Holder.Reference::value);
    }
}
