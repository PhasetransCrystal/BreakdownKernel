...
import net.ptcrys.breakdown.api.eventdispatch.EventDispatcher;
import net.ptcrys.breakdown.api.eventdispatch.IEntityAboutEvent;
 ...
 *
 * <p>
 * 负责监听全局事件总线并将其转发到相关实体的 {@link net.ptcrys.breakdown.api.eventdispatch.EventDistributor}。
 *
 * <p>
 * <b>转发类型：</b>
 * <ul>
