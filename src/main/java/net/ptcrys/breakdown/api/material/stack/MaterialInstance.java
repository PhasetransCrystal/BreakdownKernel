...
public interface MaterialInstance extends TypedInstance<Material>, DataComponentGetter {
    ...
    Codec<Holder<Material>> MATERIAL_HOLDER_CODEC = BreaRegistries.MATERIALS
            .holderByNameCodec()
            .validate(material -> material.is(MarkerMaterial.NULL.builtInRegistryHolder()) ? DataResult.error(() -> "Material must not be breakdown:null") : DataResult.success(material));
