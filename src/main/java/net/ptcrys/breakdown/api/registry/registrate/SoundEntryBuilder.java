...
import net.ptcrys.breakdown.api.sound.ConfiguredSoundEvent;
import net.ptcrys.breakdown.api.sound.CustomSoundEntry;
import net.ptcrys.breakdown.api.sound.SoundEntry;
import net.ptcrys.breakdown.api.sound.WrappedSoundEntry;
...
public class SoundEntryBuilder {
    ...
    public SoundEntryBuilder addVariant(String name) {
        return addVariant(BreaLib.id(name));
    }
