...
public class FormattingUtil {
    ...
    public static String formatNumberReadable(long number, boolean milli) {
        return formatNumberReadable((double) number, milli, DECIMAL_FORMAT_1F, null);
    }
    ...
    public static Component formatPercentage2Places(String langKey, float percentage) {
        return Component.translatable(langKey, formatNumber2Places(percentage)).withStyle(ChatFormatting.YELLOW);
    }
}
